...
abstract class $BaseEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, DateTime createdAt, DateTime updatedAt, bool isActive});
}
...
class _$BaseEntityImpl implements _BaseEntity {
  ...
  @override
  String toString() {
    return 'BaseEntity(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, isActive: $isActive)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, createdAt, updatedAt, isActive);
...
abstract class _BaseEntity implements BaseEntity {
  const factory _BaseEntity(
      ...
      final bool isActive}) = _$BaseEntityImpl;
